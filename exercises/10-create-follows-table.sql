...
CREATE TABLE IF NOT EXISTS follows(id SERIAL PRIMARY KEY, following VARCHAR references users(email) NOT NULL,
follower VARCHAR  references users(email) NOT NULL, created_at TIMESTAMP DEFAULT now());